...
/** This class describes a shift register 74HC595 as an expander: a circuit which provides 8 pins per circuit, 
...
{
	private:
		ShiftRegister74HC595<Size> *psr; // Create an 74HC595 object to be used throughout
	...
	public:
		...
		@return Always true.
		*/
		byte begin(int inID, int serialDataPin, int clockPin, int latchPin);
